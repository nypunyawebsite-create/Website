...
import WhyChooseNypunya from './WhyChooseNypunya';
...
const DermatologyServices = () => {
    ...
    return (
        <>
            <div className="p-4 md:p-6 flex flex-col justify-center items-center pt-20">
                <div className="w-full max-w-7xl">
                    <h2 className="text-2xl md:text-3xl font-bold mb-8 text-center">
                        Dermatology Services in Bangalore
                    </h2>
            ...
            {/* Why Choose Nypunya Aesthetics Section */}
            <WhyChooseNypunya />

            {/* Transformations That Inspire Section */}
