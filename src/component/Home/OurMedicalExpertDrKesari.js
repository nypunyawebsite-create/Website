                ...
                <div className="relative">
                    ...
                    <div className="rounded-xl overflow-hidden shadow-lg h-[600px] md:h-[700px] lg:h-[800px]" >
                        {currentSlide === 3 ? (
                            ...
                            // Ninth slide - Image with Linktree link
                            <div className="h-full flex items-center justify-center relative">
                                <img
                                    ...
                                    className="w-full h-full object-contain"
                                />
                                {/* Linktree Link - Bottom Left */}
                                <div className="absolute bottom-4 left-4">
                                    <a
                                        href="https://linktr.ee/drprashanthakesari"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center gap-2 bg-white bg-opacity-90 hover:bg-opacity-100 px-4 py-2 rounded-lg shadow-lg transition-all duration-300 hover:scale-105"
                                    >
                                        <svg className="w-5 h-5 text-black" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M12.586 4.586a2 2 0 112.828 2.828l-3 3a2 2 0 01-2.828 0 1 1 0 00-1.414 1.414 4 4 0 005.656 0l3-3a4 4 0 00-5.656-5.656l-1.5 1.5a1 1 0 101.414 1.414l1.5-1.5zm-5 5a2 2 0 012.828 0 1 1 0 101.414-1.414 4 4 0 00-5.656 0l-3 3a4 4 0 105.656 5.656l1.5-1.5a1 1 0 10-1.414-1.414l-1.5 1.5a2 2 0 11-2.828-2.828l3-3z" clipRule="evenodd" />
                                        </svg>
                                        <span className="text-black font-semibold text-sm">linktr.ee/drprashanthakesari</span>
                                    </a>
                                </div>
                            </div>
                        ) : (
